  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.detail}>
         <Text style={styles.memutar}>Profil Aku</Text>
            <Image
                style={{width: 160, height:160, borderRadius:10, marginTop:25}}
                source={require('../assets/profilCarin.png')}
            />
        <Text style={styles.teks}>Carin Akiela Amanda</Text>
        <Text style={styles.teks}>120140009</Text>
